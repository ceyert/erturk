...
int main() {
    ...
    std::cout << "int and unsigned int are the same: " << erturk::meta::is_same<int, unsigned int>::value << std::endl;
   ...
   // std::cout << "Max type size of int and double: " << erturk::computational::max_type<int, double>::type << std::endl;
   
   // std::cout << "Min type size of int and double: " << erturk::computational::min_type<int, double>::value << std::endl;
   
   // std::cout << "Length of types_sequence<int, float, double>: " << erturk::computational::length<erturk::computational::types_sequence<int, float, double>>::value << std::endl;
    ...
    std::cout << "Does the sequence 1, 2, 3, 4 contain 3? " << erturk::computational::contains<3, 1, 2, 3, 4>::value << std::endl;
